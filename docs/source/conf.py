# -*- coding: utf-8 -*-
#
# Sphinx configuration for aiida-spirit
#
...
project = u'aiida-spirit'
copyright_first_year = '2021'
copyright_owners = 'The JuDFT Team'
...
release = aiida_spirit.__version__
...
html_use_opensearch = 'http://aiida-spirit.readthedocs.io'
...
htmlhelp_basename = 'aiida-spirit-doc'
...
def run_apidoc(_):
    ...
    package_dir = os.path.join(source_dir, os.pardir, os.pardir, 'aiida_spirit')
